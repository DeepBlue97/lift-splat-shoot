...
class LiftSplatShoot(nn.Module):
    ...
    def get_geometry(self, rots, trans, intrins, post_rots, post_trans):
        ...
        """
        points = self.frustum - post_trans.view(B, N, 1, 1, 1, 3)  # torch.Size([4, 5, 41, 8, 22, 3])
    ...
    def voxel_pooling(self, geom_feats, x):
        # geom_feats.shape: torch.Size([4, 5, 41, 8, 22, 3])
        ...
        # x.shape: torch.Size([137828, 64]), geom_feats.shape: torch.Size([137828, 4]), ranks.shape: torch.Size([137828])
        # cumsum trick
    ...
    def forward(self, x, rots, trans, intrins, post_rots, post_trans):
        ...
        rots.shape: torch.Size([4, 5, 3, 3])  rotation
        trans.shape: torch.Size([4, 5, 3])  translation
